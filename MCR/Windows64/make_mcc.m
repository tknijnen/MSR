...
str = ['mcc -R ''-logfile,log_msr_runtime_SIGNAL.txt'' -m -I ' pwd '/ -d ' pwd ' ' function_name ' -a ./mfiles']
eval(str)


function_name = 'msr_runtime_BED.m';
str = ['mcc -R ''-logfile,log_msr_runtime_BED.txt'' -m -I ' pwd '/ -d ' pwd ' ' function_name ' -a ./mfiles']
eval(str)
